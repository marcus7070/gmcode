...
@pytest.mark.parametrize(
    "idx,word",
    [(8, "P0.0500"), (8, "Q0.0500"), (10, "X1.0417"), (10, "Y0.0000"), (10, "Z0.0000")],
)
def test_line_contains_word(gcodefile, idx, word):
    assert gcodefile.line_contains_word(idx, word)


@pytest.mark.parametrize("idx,word", [(1, "X0"), (8, "F234")])
def test_lines_not_contains_word(gcodefile, idx, word):
    assert not gcodefile.line_contains_word(idx, word)
